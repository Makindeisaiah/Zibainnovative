    ...
    >
      <Container size="default">
        ...
        >
          ...
          {/* Submission Form */}
          {submitted ? (
            <div className="bg-[#EBFDF2] border border-[#86EFAC] rounded-2xl p-6 max-w-md mx-auto flex items-center justify-center gap-3 text-[#15803D]">
            ...
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto text-left">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 sm:px-5 py-3.5 sm:py-4 rounded-xl bg-[#F1F3F5] text-[#0E1322] placeholder-[#94A3B8] border border-transparent focus:border-[#22C55E] focus:bg-white focus:outline-none transition-all text-sm sm:text-base"
                />
              </div>
              ...
              <button
                ...
                type="submit"
                className="w-full py-3.5 sm:py-4 rounded-xl bg-[#27272A] hover:bg-[#18181B] text-white font-semibold text-sm sm:text-base shadow-sm hover:shadow transition-all duration-200 cursor-pointer mt-2"
              >
                Submit
              </button>
            </form>
